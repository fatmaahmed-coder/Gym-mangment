        ...
        >
          <Form>
            ...
            <div className="mb-3">
              ...
              <ErrorMessage name="email" component="div" className="form-error text-danger" />
            </div>
            ...
            <div className="mb-3">
              ...
              <ErrorMessage name="phone" component="div" className="form-error text-danger" />
            </div>
            ...
            <div className="row">
              <div className="col-md-4 mb-3">
                ...
                <ErrorMessage name="city" component="div" className="form-error text-danger" />
              </div>

              <div className="col-md-4 mb-3">
                <label className="form-label">Street</label>
                <Field name="street" className="form-control" />
                <ErrorMessage name="street" component="div" className="form-error text-danger" />
              </div>
            ...
            <div className="mb-3">
              ...
              <ErrorMessage name="gender" component="div" className="form-error text-danger" />
            </div>
            ...
            <div className="mb-3">
              ...
              <ErrorMessage name="password" component="div" className="form-error text-danger" />
            </div>
